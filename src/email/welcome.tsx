  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={heroText}>
          I am pumped to have you on this fitness journey with me. You'll be notified when new
          courses are released and what to expect. Enoy your first course 10% off with your one time
          code below. Time to get to work!
        </Text>
